...
export function PersonalDataPage() {
  ...
  const MobileDropdown = () => (
    <>
      ...
      {/* Dropdown Menu */}
      <div className={`
        fixed top-16 left-0 right-0 bg-white border-b shadow-lg z-50
        transition-all duration-300 ease-in-out overflow-hidden
        ${mobileDropdownOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'}
        md:hidden
      `}>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Mobile Header */}
      <div className="md:hidden bg-white border-b shadow-sm sticky top-0 z-40">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            <div className="text-red-600">
              <h1 className="text-lg font-bold">Daya Motor</h1>
